      ...
      # -------------------------- loed image
       if self.applyCLAHE==False and self.grayScale ==False:
           ...
           # img = img.resize((self.img_size,self.img_size)) 
               # img = Image.fromarray(img) # fig = plt.figure(); plt.imshow(img); plt.title('CLAHE image: '+str(img.size))
